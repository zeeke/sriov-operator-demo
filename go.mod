...
require (
	github.com/k8snetworkplumbingwg/sriov-network-operator v1.5.1-0.20250624150923-9f722c128fbf
...
require (
	...
	github.com/openshift/api v0.0.0-20250613121526-24766a2cd069 // indirect
